...
<body>
    ...
    <li><a href="./userinfo.php"><i class="fa-solid fa-id-badge"></i>Profile</a></li>
      <li><a href="./support.php"><i class="fa-solid fa-info"></i>Support</a></li>
                    ...
                    <?php foreach ($deposits as $deposit): ?>
                        <tr>
                            <td><?php echo date('Y-m-d H:i:s', strtotime($deposit['created_at'])); ?></td>
                               <td>
                                                        <img src="./css/images/<?= htmlspecialchars($deposit['gateway']); ?>.png"
                                                            alt="<?= htmlspecialchars($deposit['gateway']); ?>"
                                                            style="width: 25px;">
                                                        <?= htmlspecialchars($deposit['gateway']); ?>
                                                    </td>
